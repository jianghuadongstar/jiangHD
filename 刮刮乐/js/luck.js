/**
 * Created by 姜华东 on 2016/12/21.
 */
/**
 *
 * @param id 刮奖容器的id
 * @param cover 涂层内容，可以为图片地址或颜色值，可空，默认为 #ccc
 * @param coverType 涂层类型，值为 image 或 color，可空，默认为 color
 * @param width 刮奖区域宽度，默认为300px，可空
 * @param height 刮奖区域高度，默认为100px，可空
 * @param drawPercentCallback 刮开的区域百分比回调，可空
 * @constructor
 */
